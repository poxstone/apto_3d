...
# video
export CLOUD_ML_JOB='{ "renders":[ { "bucket_model":"gs://zinc-anvil-320815-3dmodels/3dmodel", "blender_params":"--python ./blender_init.py -b ./main.blend -o ./render/render_ -F MPEG -x 1 -E CYCLES -t 8 -s 1 -e 1 -a"}] }'