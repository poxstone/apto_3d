...
export CLOUD_ML_JOB='{ "renders":[ { "bucket_model":"'${BUCKET_MODEL_SAVED}'", "blender_params":"--python ./blender_init.py -b ./main.blend -o ./render/render_ -x 1 -E CYCLES -t 8 -s 0 -e 260 -j 1 -a"}] }'
# Images export -  engines: BLENDER_EEVEE BLENDER_WORKBENCH CYCLES
export CLOUD_ML_JOB='{ "renders":[ { "bucket_model":"'${BUCKET_MODEL_SAVED}'", "blender_params":"--python ./blender_init.py -b ./main.blend -o ./render/render_ -F PNG -x 1 -E CYCLES -t 8 -s 0 -e 260 -j 20 -a"}] }'
